...
return [
    ...
    // 기본 발송 이메일
    'email' => config('site.default')['info']['email'],

    // 메일 템플릿
    'template' => ['1' => '템플릿 없음', '2' => '템플릿 1'],

    // 메일 템플릿 파일명
    'templateFile' => ['1' => 'template00', '2' => 'template01'],

    // 메일 발송 타입
    'send_type' => ['1' => '회원등급', '2' => '주소록발송', '9' => '테스트발송'],

    // 메일 발송 상태
    'status' => ['S' => '성공', 'F' => '실패', 'R' => '발송중'],

    // 버튼 사용
    'use_btn' => ['1' => '자세히 보기', '2' => '바로가기', '9' => '사용 안함'],
