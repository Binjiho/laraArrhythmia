            ...
            <fieldset>
                ...
                <div class="write-wrap">
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="form-group form-group-text n2">
                                <input type="text" name="sdate" id="sdate" class="form-item" value="{{ $board->sdate ?? '' }}" readonly datepicker>
                                <span class="text">-</span>
                                <input type="text" name="edate" id="edate" class="form-item" value="{{ $board->edate ?? '' }}" readonly datepicker>
                            </div>
                        </dd>
                    </dl>
                    <dl>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="filebox">
                                <input class="upload-name form-item" id="fileName1" value="{{ $research->file_path1 ?? '' }}" placeholder="파일첨부">
                                <label for="file1">파일첨부</label>
                                <input type="file" id="file1" name="file1" class="file-upload">
                                @if (!empty($research->file_path1))
                                    <div class="attach-file">
                                        <a href="{{ $research->downloadFileUrl('file_path1', 'file_name1') }}" target="_blank" class="link">{{$research->file_path1}}</a>
                                    </div>
                                @endif
                            </div>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="filebox">
                                <input class="upload-name form-item" value="{{ $research->file_path2 ?? '' }}" placeholder="파일첨부">
                                <label for="file2">파일첨부</label>
                                <input type="file" id="file2" name="file2" class="file-upload">
                                @if (!empty($research->file_path2))
                                    <div class="attach-file">
                                        <a href="{{ $research->downloadFileUrl('file_path2', 'file_name2') }}" target="_blank" class="link">{{$research->file_path2}}</a>
                                    </div>
                                @endif
                            </div>
                        </dd>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="filebox">
                                <input class="upload-name form-item" value="{{ $research->file_path3 ?? '' }}" placeholder="파일첨부">
                                <label for="file3">파일첨부</label>
                                <input type="file" id="file3" name="file3" class="file-upload">
                                @if (!empty($research->file_path3))
                                    <div class="attach-file">
                                        <a href="{{ $research->downloadFileUrl('file_path3', 'file_name3') }}" target="_blank" class="link">{{$research->file_path3}}</a>
                                    </div>
                                @endif
                            </div>
                        </dd>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="filebox">
                                <input class="upload-name form-item" value="{{ $research->file_path4 ?? '' }}" placeholder="파일첨부">
                                <label for="file4">파일첨부</label>
                                <input type="file" id="file4" name="file4" class="file-upload">
                                @if (!empty($research->file_path4))
                                    <div class="attach-file">
                                        <a href="{{ $research->downloadFileUrl('file_path4', 'file_name4') }}" target="_blank" class="link">{{$research->file_path4}}</a>
                                    </div>
                                @endif
                            </div>
                        </dd>
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="filebox">
                                <input class="upload-name form-item" value="{{ $research->file_path5 ?? '' }}" placeholder="파일첨부">
                                <label for="file5">파일첨부</label>
                                <input type="file" id="file5" name="file5" class="file-upload">

                                @if (!empty($research->file_path5))
                                    <div class="attach-file">
                                        <a href="{{ $research->downloadFileUrl('file_path5', 'file_name5') }}" target="_blank" class="link">{{$research->file_path5}}</a>
                                    </div>
                                @endif
                            </div>
                ...
                <div class="btn-wrap text-center">
                    <a href="{{route('research.info')}}" class="btn btn-type1 color-type4">취소</a>
