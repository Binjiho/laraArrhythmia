    ...
    <article class="sub-contents">
        <div class="sub-conbox inner-layer">
            <div class="sub-tit-wrap">
                <h3 class="sub-tit">인사말</h3>
            </div>
            <div class="greeting-wrap">
                <strong class="tit m-show">존경하는 대한부정맥학회 회원 여러분,</strong>
                <div class="img-wrap">
                    <div class="img">
                        <img src="/assets/image/sub/img_greeting_2024.jpg" alt="대한부정맥학회 이사장 차태준">
                    </div>
                    <div class="name">
                        대한부정맥학회 이사장
                        <img src="/assets/image/sub/img_sign.png" alt="차태준">
                    </div>
                </div>
                <div class="text-wrap">
