...
@section('contents')
    <div class="contents">
        ...
        <form class="searchArea">
            <form id="search-frm" action="{{ route('reviewer',['code'=>'research']) }}" method="get">
                <fieldset>
                ...
                <div class="util btn" style="display: flex; justify-content: center; margin-top: 20px;">
                    ...
                    <a href="{{ route('reviewer',['code'=>'research']) }}" class="btnBdNavy">검색초기화</a>
                    <a href="{{ route('reviewer.excel', ['code'=>'research'], request()->except(['page']) ) }}" class="btnBdBlue">데이터 백업</a>
                </div>
            </form>
        </form>

        <div class="util btn" style="display: flex; justify-content: flex-start; margin-top: 20px;">
            <a href="{{ route('reviewer.upsert',['code'=>'research']) }}" class="call_popup btnBdNavy" data-popup_name="fee-create" data-width="900" data-height="900">
                등록
            </a>
        </div>
