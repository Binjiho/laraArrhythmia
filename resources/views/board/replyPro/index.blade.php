            ...
            <ul class="board-list">
                ...
                @foreach($list ?? [] as $row)
                    ...
                    @foreach($row->replies as $reply)
                        <li class="" data-sid="{{ $reply->sid }}">
                            <div class="bbs-no">
                                <img src="/assets/image/board/ic_reply.png" alt="" class="ic-reply">
                            </div>
                            <div class="bbs-tit">
                                <a href="{{ route('board.reply.view', ['code' => $code, 'bsid' => $row->sid, 'sid' => $reply->sid]) }}" class="ellipsis">{{ $reply->subject }}</a>
                            </div>
                            <div class="bbs-file">
                            ...
                            @if(isAdmin())
                                ...
                                <div class="bbs-admin">
                                    <div class="btn-admin">
                                        <a href="{{ route('board.reply.upsert', ['code' => $code, 'bsid' => $row->sid, 'sid' => $reply->sid]) }}" class="btn btn-board btn-modify">수정</a>
