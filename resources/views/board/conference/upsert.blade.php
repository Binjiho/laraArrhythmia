                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="form-group form-group-text n2">
                                                    ...
                                                    <input type="text" name="event_edate" id="event_edate" class="form-item" value="{{ $board->event_edate ?? '' }}" {{ ($board->date_type ?? '' =='D' ) ? 'disabled=disabled' : '' }} readonly datepicker>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl>
                                            <dt>장소</dt>
                                            <dd>
                                                <input type="text" name="place" id="place" value="{{ $board->place ?? '' }}" class="form-item">
                                            </dd>
                                        </dl>
                                        <dl>
                                            <dt>사전등록 기간</dt>
                                            <dd>
                                                <div class="form-group form-group-text n2">
                                                    <input type="text" name="regist_sdate" id="regist_sdate" class="form-item" value="{{ $board->regist_sdate ?? '' }}" readonly datepicker>
                                                    <span class="text">~</span>
                                                    <input type="text" name="regist_edate" id="regist_edate" class="form-item" value="{{ $board->regist_edate ?? '' }}" readonly datepicker>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="form-group form-group-text n2">
                                                    <input type="text" name="abs_sdate" id="abs_sdate" class="form-item" value="{{ $board->abs_sdate ?? '' }}" readonly datepicker>
                                                    <span class="text">~</span>
                                                    <input type="text" name="abs_edate" id="abs_edate" class="form-item" value="{{ $board->abs_edate ?? '' }}" readonly datepicker>
                                                </div>
                                            </dd>
                                        </dl>
