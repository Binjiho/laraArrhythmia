...
{{--                                                </div>--}}
                                        ...
                                        <dl class="popupBox" style="display: {{ $popupDisplay }}">
                                            ...
                                            <dd>
                                                <ul class="popSize">
                                                    <li>
                                                        <span>사이즈 :</span>
                                                        <input type="text" name="popup_width" id="popup_width" value="{{ $board->popup_width ?? '500' }}" maxlength="4" onlyNumber>
                                                        <span> X </span>
                                                        <input type="text" name="popup_height" id="popup_height" value="{{ $board->popup_height ?? '400' }}" maxlength="4" onlyNumber>
                                                    </li>

                                                    <li>
                                                        <span>위치 :</span>
                                                        <span>위에서 </span>
                                                        <input type="text" name="popup_position_y" id="popup_position_y" value="{{ $board->popup_position_y ?? '0' }}" maxlength="4" onlyNumber>
                                                        <span>px, </span>

                                                        <span>왼쪽에서 </span>
                                                        <input type="text" name="popup_position_x" id="popup_position_x" value="{{ $board->popup_position_x ?? '0' }}" maxlength="4" onlyNumber>
                                                        <span>px</span>
                                                    </li>
                                                </ul>
                                            </dd>
                                        ...
                                        <dl class="popupBox" style="display: {{ $popupDisplay }}">
                                            ...
                                            <dd>
                                                <span>시작일 : </span>
                                                <input type="text" name="popup_startdate" id="popup_startdate" value="{{ $board->popup_startdate ?? '' }}" readonly datepicker>

                                                <span>종료일 : </span>
                                                <input type="text" name="popup_enddate" id="popup_enddate" value="{{ $board->popup_enddate ?? '' }}" readonly datepicker>
                                            </dd>
                                        </dl>
                                        ...
                                        <dl class="popupDetailBox" style="display: {{ $popupDetailDisplay }}">
                                            <dt>자세히 보기 LINK</dt>
                                            <dd>
                                                <input type="text" value="{{ $board->popup_link ?? '' }}" name="popup_link" id="popup_link" style="width: 100%;">
                                            </dd>
                                        </dl>

                                        <dl class="popupContentBox" style="display: {{ $popupContentDisplay }}">
                                            <dd>
                                                <textarea name="popup_content" id="popup_content" class="tinymce">{{ $board->popup_content ?? '' }}</textarea>
                                            </dd>
                                        </dl>
                                    @endif
    ...
    <script>
        ...
        if(boardConfig.use.popup) {
            ...
            $(document).on('click', '#popup_preview', function(e) {
                ...
                // previewData.case = 'popup-preview';
        ...
        $(boardForm).validate({
            ...
            messages: {
                ...
                popup_select: {
                    checkEmpty: '팝업 내용선택을 체크해주세요.',
                },
                popup_detail: {
                    checkEmpty: '팝업 자세히보기를 체크해주세요.',
                },
                popup_startdate: {
                    isEmpty: '팝업 시작일을 입력해주세요.',
                },
                popup_enddate: {
                    isEmpty: '팝업 마감일을 입력해주세요.',
                },
                popup_content: {
