...
<article class="sub-contents">
    <div class="sub-conbox inner-layer">
        ...
        <div id="board" class="board-wrap">
            <div class="sch-form-wrap">
                <form action="{{ route('board', ['code' => $code]) }}" method="get">
                    <fieldset>
                        ...
                        <div class="sch-wrap">
                            <span class="cnt">Total <strong class="text-skyblue">{{ number_format($total) }}</strong> </span>
            ...
            <ul class="board-list">
                <li class="list-head">
                    <div class="bbs-no">No</div>
                    <div class="bbs-tit">Subject</div>
                    <div class="bbs-file">File</div>
                    <div class="bbs-date">Date</div>
                    <div class="bbs-hit">View</div>

                    @if(isAdmin())
                        <div class="bbs-show">Open</div>
                        <div class="bbs-admin">Admin</div>
                    @endif
                </li>
                ...
                @foreach($list ?? [] as $row)
                    <li class="active" data-sid="{{ $row->sid }}">
                        ...
                        @if(isAdmin())
                            ...
                            <div class="bbs-admin">
                                <div class="btn-admin">
                                    <a href="{{ route('board.upsert', ['code' => $code, 'sid' => $row->sid]) }}" class="btn btn-board btn-modify">Mod</a>
                                    <a href="javascript:void(0);" class="btn btn-board btn-delete">Del</a>
                                </div>
                            </div>
                        @endif
                    </li>
