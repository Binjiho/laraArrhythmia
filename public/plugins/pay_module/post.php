...
<?php include $_SERVER['DOCUMENT_ROOT']. "/ksnet/pc/KSPayWebHost.inc"; ?>
  ...
  $ipg = new KSPayWebHost($rcid, null,$payamt);
...

	{
...

		{
			...
			if($authyn != "O"){
				\Workshop\Func::form_send_message('/registration/apply.php', ['mode'=>'pay_fail', 'sid'=>$_POST['sid']], "Payment declined [".$resultcd." : ".($msg1??'').($msg2?'('.$msg2.')':'')."]\\nPlease contact the website administrator.");
				exit;
			}
        }
