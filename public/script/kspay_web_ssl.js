...
var submitI = function(formid,  ifrmName, iWinX, iWinY) {
    ...
    if (formid.target != ifrmName) {
        if(document.getElementById("popup") == null )
        {
            ...
            installpop += "<div id=\"popup\" style=\"position:fixed; top:50%; left:50%; width:"+iWinX+"px; height:"+iWinY+"px; border-radius:20px; margin-left:-" + parseInt(iWinX, 10)/2 + "px;margin-top:-" + parseInt(iWinY, 10)/2 + "px;  z-index: 10000; text-align: center; \" >";
